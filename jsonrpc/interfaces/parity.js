...
var SECTION_ACCOUNTS = 'Accounts (read-only) and Signatures';
var SECTION_DEV = 'Development';
var SECTION_MINING = 'Block Authoring (aka "mining")';
var SECTION_NET = 'Network Information';
var SECTION_NODE = 'Node Settings';
var SECTION_VAULT = 'Account Vaults';

var SUBDOC_SET = 'set';
var SUBDOC_ACCOUNTS = 'accounts';exports.default =

{
  ...
  gasFloorTarget: {
    ...
    returns: {
      ...
      example: (0, _helpers.fromDecimal)(4700000) } },
  ...
  gasCeilTarget: {
    ...
    returns: {
      ...
      format: 'outputBigNumberFormatter',
      example: (0, _helpers.fromDecimal)(6283184) } },
  ...
  minGasPrice: {
    ...
    returns: {
      ...
      format: 'outputBigNumberFormatter',
      example: (0, _helpers.fromDecimal)(11262783488) } },
  ...
  nextNonce: {
    ...
    returns: {
      ...
      example: (0, _helpers.fromDecimal)(12) } },
  ...
  pendingTransactions: {
    ...
    returns: {
      ...
      details: _types.TransactionResponse.details,
      example: [
      {
        blockHash: null,
        blockNumber: null,
  ...
  setMinGasPrice: {
    ...
    params: [
    {
      ...
      desc: 'Minimal gas price',
      format: 'utils.toHex',
      example: (0, _helpers.fromDecimal)(1000) }],
  ...
  setGasCeilTarget: {
    ...
    params: [
    {
      ...
      format: 'utils.toHex',
      example: (0, _helpers.fromDecimal)(10000000000) }],
  ...
  setMaxTransactionGas: {
    ...
    params: [
    {
      ...
      desc: 'Gas amount',
      format: 'utils.toHex',
      example: (0, _helpers.fromDecimal)(100000) }],
  ...
  cidV0: {
    ...
    returns: {
      ...
      example: 'QmSbFjqjd6nFwNHqsBCC7SK8GShGcayLUEtysJjNGhZAnC' } } };module.exports = exports['default'];