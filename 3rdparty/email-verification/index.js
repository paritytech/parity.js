...
var isServerRunning = exports.isServerRunning = function isServerRunning() {var isTestnet = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  var port = isTestnet ? 28443 : 18443;
...
var hasReceivedCode = exports.hasReceivedCode = function hasReceivedCode(email, address) {var isTestnet = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;var port = isTestnet ? 28443 : 18443;var query = (0, _querystring.stringify)({ email: email, address: address });return fetch('https://email-verification.parity.io:' + port + '/?' + query, { mode: 'cors', cache: 'no-store' }).then(function (res) {return res.ok;}).
  catch(function () {
